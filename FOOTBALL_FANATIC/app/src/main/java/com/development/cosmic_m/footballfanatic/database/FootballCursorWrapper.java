package com.development.cosmic_m.footballfanatic.database;

import android.database.Cursor;
import android.database.CursorWrapper;

import com.development.cosmic_m.footballfanatic.Event;
import com.development.cosmic_m.footballfanatic.League;
import com.development.cosmic_m.footballfanatic.TeamStanding;
...
public class FootballCursorWrapper extends CursorWrapper {
    ...
    public TeamStanding inflateTeamStanding(TeamStanding ts) {
        ...
        String resourceOfPicture = getString(getColumnIndex(SchemaDB.TeamStandingTable.Cols.InnerCols.RESOURCE_IMAGE));
        ...
        standing.setResourceOfPicture(resourceOfPicture);
