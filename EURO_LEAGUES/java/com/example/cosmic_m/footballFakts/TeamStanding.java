...
public class TeamStanding implements Serializable{
    ...
    public void method(String team, int matchDay, int pts){
        getStandingByTeam(team).getMassOfLastResults()[38 - matchDay] = pts;
    }
    ...
    public class Standing {
        ...
        public void putSomeLastResult(int matchDay, int pts){
            fifeLastResults[matchDay] = pts;
        }
